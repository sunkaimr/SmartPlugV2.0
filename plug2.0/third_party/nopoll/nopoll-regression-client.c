...
#define local_PLUG_NAME		"iot.espressif.cn"
...
nopoll_bool test_01 (void) {
	...
	conn = nopoll_conn_new (ctx, local_PLUG_NAME, local_host_port, NULL, NULL, NULL, NULL);
...
nopoll_bool test_06 (void) {
	...
	/* call to create a connection */
	conn = nopoll_conn_tls_new (ctx, opts, local_PLUG_NAME, local_host_ports, NULL, local_host_url, NULL, NULL);
	if (! nopoll_conn_is_ok (conn)) {
		printf ("ERROR: Expected to find proper client connection status, but found error..\n");
		return nopoll_false;
	}
...
nopoll_bool test_07 (void) {
	...
	/* call to create a connection */
	conn = nopoll_conn_tls_new (ctx, opts, local_PLUG_NAME, local_host_ports, NULL, NULL, NULL, NULL);
	if (! nopoll_conn_is_ok (conn)) {
		printf ("ERROR: Expected to find proper client connection status, but found error..\n");
		return nopoll_false;
	} /* end if */
...
nopoll_bool test_10 (void) {
	...
	conn = nopoll_conn_new (ctx, local_PLUG_NAME, local_host_port, NULL, NULL, NULL, "http://deny.aspl.es");
...
nopoll_bool test_21 (void) {
	...
	conn = nopoll_conn_tls_new (ctx, NULL, local_PLUG_NAME, local_host_ports, NULL, NULL, NULL, NULL);
	if (nopoll_conn_is_ok (conn)) {
...
nopoll_bool test_24 (void) {
	...
	/* create connection */
	conn = nopoll_conn_new_opts (ctx, opts, local_PLUG_NAME, local_host_port, NULL, NULL, NULL, NULL);
	if (! nopoll_conn_is_ok (conn)) {
		printf ("ERROR: Expected to find proper client connection status, but found error..\n");
		return nopoll_false;
	}
...
nopoll_bool test_27 (void) {
	...
	/* create connection */
	conn = nopoll_conn_new (ctx, local_PLUG_NAME, local_host_port, NULL, "/", "chat-protocol", "http://www.aspl.es");
	if (! nopoll_conn_is_ok (conn)) {
		printf ("ERROR: Expected to find proper client connection status, but found error..\n");
		return nopoll_false;
	} /* end if */
	...
	/* create connection */
	conn = nopoll_conn_new (ctx, local_PLUG_NAME, local_host_port, NULL, "/", "hello-protocol", "http://www.aspl.es");
	if (! nopoll_conn_is_ok (conn)) {
		printf ("ERROR: Expected to find proper client connection status, but found error..\n");
		return nopoll_false;
	} /* end if */
